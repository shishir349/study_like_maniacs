			...
			<div class="row">
				...
				<div class="col-lg-8">
					...
					<div class="course_container">
						<div class="course_title">Dr. Neelotpal</div>
					
						<!-- Course Image -->
						<div class="course_image"><img src="../srpc2/img/mandeep.jpg" alt=""></div>
								...
								<div class="tab_panel active">
									...
									<div class="tab_panel_content">
										<div class="tab_panel_text">
											<p>Dr. Neelotpal has worked in many mediums. He began as a legislative assistant in Delhi, became a lab assisstant, and even coached soccer. At the end of the day though, he has never felt quite as fulfilled and satisfied as he does now after arriving home from teaching a class.
							...
							<div class="sidebar_feature">
								...
								<div class="feature_list">
									...
									<div class="feature d-flex flex-row align-items-center justify-content-start">
										<div class="feature_title"><i class="fa fa-file-text-o" aria-hidden="true"></i><span>Excel:</span></div>
										<div class="feature_text ml-auto"><a href="rptTimeTableStudent.pdf">Download letures</a></div>
									</div>

									<!-- Feature -->
									<div class="feature d-flex flex-row align-items-center justify-content-start">
										<div class="feature_title"><i class="fa fa-file-text-o" aria-hidden="true"></i><span>R programming:</span></div>
										<div class="feature_text ml-auto"><a href="rptTimeTableStudent.pdf">Download letures</a></div>
									</div>

									<!-- Feature -->
									<div class="feature d-flex flex-row align-items-center justify-content-start">
										<div class="feature_title"><i class="fa fa-file-text-o" aria-hidden="true"></i><span>Data Visualization:</span></div>
										<div class="feature_text ml-auto"><a href="rptTimeTableStudent.pdf">Download letures</a></div>
									</div>

										<div class="feature d-flex flex-row align-items-center justify-content-start">
										<div class="feature_title"><i class="fa fa-file-text-o" aria-hidden="true"></i><span>Predictive Analysis:</span></div>
										<div class="feature_text ml-auto"><a href="rptTimeTableStudent.pdf">Download letures</a></div>
									</div>
...
<br>
	...
	&nbsp;&nbsp;&nbsp;<div class="row">					
<div class="col-sm-6">
	<iframe width="560" height="315" src="https://www.youtube.com/embed/xUM-GvJwTrw" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
</div>

<div class="col-sm-6">
	<iframe width="560" height="315" src="https://www.youtube.com/embed/eDrhZb2onWY" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
</div>
	</div>			
