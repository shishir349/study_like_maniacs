					...
					<div class="row">
						<div class="col">
							<div class="top_bar_content d-flex flex-row align-items-center justify-content-start">
								...
								<div class="top_bar_login ml-auto">
									<div class="logout_button"><a href="index.php"><input type="submit" class="btn btn-danger" name="logout" value="Logout"></a></div>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="row">
				...
				<div class="col-lg-8">
					...
					<div class="course_container">
						<div class="course_title">Dr. Nilesh</div>
					
						<!-- Course Image -->
						<div class="course_image"><img src="../srpc2/img/saurbah.jpg" alt=""></div>
							...
							<div class="sidebar_feature">
								...
								<div class="feature_list">
									...
									<div class="feature d-flex flex-row align-items-center justify-content-start">
										<div class="feature_title"><i class="fa fa-file-text-o" aria-hidden="true"></i><span>Big Data With Hadoop</span></div>
										<div class="feature_text ml-auto"><a href="rptTimeTableStudent.pdf">Download letures</a></div>
									</div>

									<!-- Feature -->
									<div class="feature d-flex flex-row align-items-center justify-content-start">
										<div class="feature_title"><i class="fa fa-file-text-o" aria-hidden="true"></i><span>Spark Programming</span></div>
										<div class="feature_text ml-auto"><a href="rptTimeTableStudent.pdf">Download letures</a></div>
									</div>

									<!-- Feature -->
									<div class="feature d-flex flex-row align-items-center justify-content-start">
										<div class="feature_title"><i class="fa fa-file-text-o" aria-hidden="true"></i><span>Scala Programing</span></div>
										<div class="feature_text ml-auto"><a href="rptTimeTableStudent.pdf">Download letures</a></div>
									</div>

										<div class="feature d-flex flex-row align-items-center justify-content-start">
										<div class="feature_title"><i class="fa fa-file-text-o" aria-hidden="true"></i><span>SAS Programming</span></div>
										<div class="feature_text ml-auto"><a href="rptTimeTableStudent.pdf">Download letures</a></div>
									</div>
...
<br>
	...
	&nbsp;&nbsp;&nbsp;<div class="row">					
<div class="col-sm-6">
	<iframe width="560" height="315" src="https://www.youtube.com/embed/mafw2-CVYnA" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
</div>

<div class="col-sm-6">
	<iframe width="560" height="315" src="https://www.youtube.com/embed/xNAD6cBKyaA" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
</div>
	</div>			
